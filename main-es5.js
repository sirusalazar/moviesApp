(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
                ...
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    ...
                    providers: [
                        ...
                        },
                        {
                            ...
                            useFactory: function (configService) { return function () {
                                return configService.retrieveMainMenu().then(function (menu) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MovieDetailsComponent = /** @class */ (function () {
                function MovieDetailsComponent(movieService, route, router) {
                ...
                MovieDetailsComponent.prototype.ngOnInit = function () {
                    ...
                    if (!this.inputedMovie) {
                        this.route.paramMap.subscribe(function (params) {
                            ...
                            _this.movie = _this.movieService.getMovie(id);
                            if (!_this.movie) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MovieItemComponent = /** @class */ (function () {
                function MovieItemComponent(movieService) {
                    this.movieService = movieService;
                }
                MovieItemComponent.prototype.ngOnInit = function () { };
                MovieItemComponent.prototype.delete = function (evt) {
                    evt.preventDefault();
                    this.movieService.deleteMovie(this.movie.id);
                };
                MovieItemComponent.prototype.toggleFavorite = function (evt) {
                    evt.preventDefault();
                    this.movieService.toggleFavorite(this.movie.id);
                };
                return MovieItemComponent;
            }());
            MovieItemComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MoviesListComponent = /** @class */ (function () {
                function MoviesListComponent(mediaObserver) {
                    var _this = this;
                    this.activeMediaQuery = "";
                    this.filterParam = "";
                    this.watcher = mediaObserver.media$.subscribe(function (change) {
                        _this.activeMediaQuery = change
                            ? "'" + change.mqAlias + "' = (" + change.mediaQuery + ")"
                            : "";
                        change.mqAlias === "xs" ? _this.sidenav.close() : _this.sidenav.open();
                        _this.currentMedia = change;
                    });
                }
                ...
                MoviesListComponent.prototype.close = function () {
                    if (this.currentMedia.mqAlias === "xs") {
                        this.sidenav.close();
                    }
                };
                MoviesListComponent.prototype.open = function () {
                    this.sidenav.open();
                };
                MoviesListComponent.prototype.applyFilter = function (filterValue) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FavoritesComponent = /** @class */ (function () {
                function FavoritesComponent(movieService) {
                    this.movieService = movieService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(media, movieSevice) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MovieFormComponent = /** @class */ (function () {
                function MovieFormComponent(movieService, _fb, route, notificationService) {
                    this.movieService = movieService;
                    this._fb = _fb;
                    this.route = route;
                ...
                MovieFormComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.routeData = this.route.data.subscribe(function (value) {
                        _this.formTitle = value.title;
                    });
                };
                MovieFormComponent.prototype.ngOnDestroy = function () {
                    this.routeData.unsubscribe();
                };
                MovieFormComponent.prototype.onSubmit = function (evt) {
                ...
                MovieFormComponent.prototype.getFormData = function () {
                    var movie = {
                ...
                MovieFormComponent.prototype.handleFileSelect = function (evt) {
                ...
                MovieFormComponent.prototype._handleReaderLoaded = function (readerEvt) {
                    this.movieBase64Img = readerEvt.target.result;
                };
                MovieFormComponent.prototype.onClearImage = function (evt) {
                    this.imageInput.clear(evt);
                    this.movieBase64Img = "";
                };
                MovieFormComponent.prototype.canDeactive = function () {
                    return this.movieForm.dirty && this.movieForm.touched
                        ? confirm("you have pending changes, would you like to continue?")
                        : true;
                };
                MovieFormComponent.prototype.generateForm = function () {
            ...
            MovieFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MovieService = /** @class */ (function () {
                function MovieService(httpClient, webStorageService) {
                ...
                MovieService.prototype.getMovie = function (movieId) {
                    var filterdMovies = this.movies.filter(function (item) { return item.id === movieId; });
                ...
                MovieService.prototype.deleteMovie = function (id) {
                    this.movies.splice(this.movies.findIndex(function (item) { return item.id === id; }), 1);
                    this.persistMovies();
                };
                MovieService.prototype.toggleFavorite = function (id) {
                    var index = this.movies.map(function (m) { return m.id; }).indexOf(id);
                    if (index > -1) {
                ...
                MovieService.prototype.getFavorites = function () {
                    return this.movies.filter(function (item) { return item.favorite; });
                };
                MovieService.prototype.persistMovies = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _moviesApp_core_services_movie_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @moviesApp-core/services/movie.service */ "./src/app/core/services/movie.service.ts");
            var TopMoviesComponent = /** @class */ (function () {
                function TopMoviesComponent(moviesService) {
                    var _this = this;
                    this.moviesService = moviesService;
                    this.moviesService.getTopMovies().subscribe(function (response) {
                        _this.moviesList = response.movies;
                    });
                }
                TopMoviesComponent.prototype.ngOnInit = function () { };
                return TopMoviesComponent;
            }());
            TopMoviesComponent.ctorParameters = function () { return [
                { type: _moviesApp_core_services_movie_service__WEBPACK_IMPORTED_MODULE_2__["MovieService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HttpErrorInterceptorService = /** @class */ (function () {
                function HttpErrorInterceptorService(notificationService) {
                    this.notificationService = notificationService;
                }
                HttpErrorInterceptorService.prototype.intercept = function (req, next) {
                    var _this = this;
                    return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
                        _this.notificationService.showErrorMessage(error.name, error.message);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            LoaderInterceptorService.ctorParameters = function () { return [
            ...
            var FilterComponent = /** @class */ (function () {
                ...
                FilterComponent.prototype.ngOnInit = function () {
                    ...
                    this.filterValueControl.valueChanges
                        ...
                        _this.filterValue = newValue;
                        _this.applyFilter.emit(_this.filterValue);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarComponent = /** @class */ (function () {
                function ToolbarComponent(configService) {
                    var _this = this;
                    this.configService = configService;
                    this.isMobileVisible = false;
                    this.onToggleMenu = function () {
                        _this.isMobileVisible = !_this.isMobileVisible;
                    };
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FilterPipe = /** @class */ (function () {
                ...
                FilterPipe.prototype.transform = function (value, args, property) {
                    if (!value) {
                        return;
                    }
                    if (!args) {
                    ...
                    return value.filter(function (item) { return item[property].toLowerCase().includes(args); });
                };
                return FilterPipe;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfigService = /** @class */ (function () {
                ...
                ConfigService.prototype.retrieveMainMenu = function () {
                ...
                ConfigService.prototype.getMenu = function () {
                    return this.mainMenu;
                };
                ConfigService.prototype.setMenu = function (menu) {
                    this.mainMenu = menu;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationService = /** @class */ (function () {
                ...
                NotificationService.prototype.showErrorMessage = function (title, message) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WebStorageService = /** @class */ (function () {
                ...
                WebStorageService.prototype.store = function (hashKey, obj) {
                    sessionStorage.setItem(hashKey, JSON.stringify(obj));
                };
                WebStorageService.prototype.retrieve = function (hashKey) {
                    var itemJsonString = sessionStorage.getItem(hashKey);
